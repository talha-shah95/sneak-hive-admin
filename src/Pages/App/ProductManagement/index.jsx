                  ...
                  >
                    ...
                    >
                      <tbody>
                        ...
                        {productsData?.data?.map((products, index) => (
                          <tr key={index}>
                            <td>
                            ...
                            <td
                              className={`text-capitalize ${
                                products?.availibility == 'in_stock'
                                  ? 'colorGreen'
                                  : products?.availibility == 'out_of_stock'
                                  ? 'colorRed'
                                  : 'colorYellowDark'
                              }`}
                            >
                            ...
                            <td>
                              <StatusDropdown
                                ...
                                options={[
                                  {
                                    value: products?.is_active == 1 ? 0 : 1,
                                    label:
                                      products?.is_active == 1
                                        ? 'Inactive'
                                        : 'Active',
                                ...
                                actions={[
                                  {
                                    ...
                                    onClick: () => {
                                      navigate(
                                        `/product-management/product-details/${products?.id}`
                                      );
                                    },
                                  },
                                  {
