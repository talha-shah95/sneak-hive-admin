...
const GetPlayerStories = async (filters, pagination) => {
  ...
  try {
    const response = await axiosInstance.get(
      `/admin/player-stories?search=${search}&from=${from}&to=${to}&status=${status}&records=${per_page}&page=${page}`
    );
...
export default GetPlayerStories;
