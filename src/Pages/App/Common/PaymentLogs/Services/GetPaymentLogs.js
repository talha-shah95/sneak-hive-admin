...
const GetPaymentLogs = async (filters, pagination) => {
  ...
  try {
    const response = await axiosInstance.get(
      `/vendor/payment-log?search=${search}&date_from=${from}&date_to=${to}&per_page=${per_page}`
    );
