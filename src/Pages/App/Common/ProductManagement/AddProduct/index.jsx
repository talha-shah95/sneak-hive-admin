...
const AddProduct = () => {
  ...
  useEffect(() => {
    if (productFormData) {
      setCategoryId(productFormData?.product_categories[0]?.value);
    }
  }, [productFormData]);

  useEffect(() => {
    if (subCategoryData && subCategoryData.length > 0) {
      setSubCategoryId(subCategoryData[0]?.value);
    }
  }, [subCategoryData]);
              ...
              <>
                <Formik
                  initialValues={{
                    ...
                    description: '',
                    preference_id:
                      productFormData?.product_beverage_types[0]?.value || '',

                    category_id:
                      productFormData?.product_categories[1]?.value || '',
                    sub_category_id: subCategoryId || '',
                    quantity: 1,
                    package_type:
                      productFormData?.product_package_types[0]?.value || '',
                    beverage_taste: beverageTastes[0]?.value || '',
                    is_keg: 0,
                    keg_size: kegSizes[0]?.value || '',
                    keg_rental_duration: kegRentalDurations[0]?.value || '',
                    deposit: 0,
                    price: '',
                    accessories: '',
                    status: 1,
                                  ...
                                  <div className="col-12">
                                    <div className="mb-3">
                                      ...
                                      <p className="text14 colorGrayDark fw-normal">
                                        Note: At least 3 images are required
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div className="col-12">
                                    <div className="mb-3">
                                      <h3 className="secondaryTitle">
                                        Is the product you're adding a keg?
                                      </h3>
                                      ...
                                      <div className="col-12">
                                        <div className="mb-3">
                                          <CustomSelect
                                            ...
                                            disabled={!kegRentalDurations}
                                            value={values.keg_rental_duration}
                                            onChange={handleChange}
                                            onBlur={handleBlur}
                                            error={
