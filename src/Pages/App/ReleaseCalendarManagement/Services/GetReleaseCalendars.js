...
const GetReleaseCalendars = async (filters, pagination) => {
  ...
  try {
    const response = await axiosInstance.get(
      `/admin/release-calenders?search=${search}&from=${from}&to=${to}&status=${status}&records=${per_page}&page=${page}`
    );
...
export default GetReleaseCalendars;
