...
const GetBrands = async (filters, pagination) => {
  ...
  try {
    const response = await axiosInstance.get(`/admin/brands?search=${search}&from=${from}&to=${to}&status=${status}&records=${per_page}&page=${page}`);
